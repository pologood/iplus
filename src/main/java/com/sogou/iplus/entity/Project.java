...
public class Project {
  ...
  static {
    ...
    PROJECTS.add(MOBILE_BROWSER = new Project(76, "423ftqdz3cyjpa14", "浏览器-手机浏览器",
        Lists.newArrayList(new Kpi(15, "手机浏览器日活跃用户数(万)"), new Kpi(16, "手机浏览器给搜索带去的日搜索量(万)"),
            new Kpi(17, "手机浏览器日激活量(万)"), new Kpi(107, "手机浏览器Android版次日留存率"), new Kpi(108, "手机浏览器Android版第7日留存率"),
            new Kpi(109, "手机浏览器Android版第30日留存率"), new Kpi(110, "手机浏览器iOS版次日留存率"), new Kpi(111, "手机浏览器iOS版第7日留存率"),
            new Kpi(112, "手机浏览器iOS版第30日留存率")),
        BusinessUnit.DESKTOP));
    PROJECTS.add(NAVIGATION = new Project(260, "zmit8fzhdlyqj5hd",
        "导航", Lists.newArrayList(new Kpi(21, "导航合计用户数(万)"), new Kpi(22, "搜狗导航自有活跃用户数(万)"),
            new Kpi(23, "搜狗导航外购活跃用户数(万)"), new Kpi(24, "QQ独立导航活跃用户数(万)"), new Kpi(25, "QQ浏览器中QQ导航活跃用户数(万)")),
        BusinessUnit.DESKTOP));
    PROJECTS.add(VOICE = new Project(82, "95lykq31ci0fw5p7", "语音", Lists.newArrayList(new Kpi(26, "语音日请求量(万)")),
        BusinessUnit.DESKTOP));
    PROJECTS
        .add(NEWS = new Project(322, "hw9cfh7zaor7kuwd",
    ...
    PROJECTS.add(MAP = new Project(148, "h0wb4btxx2xm56xp", "手机地图",
        ...
        BusinessUnit.DESKTOP));
    PROJECTS.add(APP_MARKET = new Project(11, "ljy4vpeq567fejbj", "应用市场",
    ...
    PROJECTS.add(WIRELESS_SEARCH = new Project(20, "z1fv4fciko2gwurq", "无线网页搜索",
        Lists.newArrayList(new Kpi(40, "无线搜狗自有渠道日搜索量(万)"), new Kpi(41, "无线腾讯渠道日搜索量(万)"), new Kpi(42, "外购网页无线日搜索量(万)")),
        BusinessUnit.SEARCH));
    PROJECTS
        .add(SEARCH_APP = new Project(232, "sohampb0dogwgxuz", "搜索APP",
    ...
    PROJECTS.add(VEDIO_SEARCH = new Project(141, "t4nnt1t5a055mjch", "视频搜索",
        Lists.newArrayList(new Kpi(49, "视频搜索(PC+无线)用户量(万)")), BusinessUnit.SEARCH));
    PROJECTS.add(PICTURE_SEARCH = new Project(138, "wzze931ap6087cf7", "图片搜索",
        Lists.newArrayList(new Kpi(50, "图片搜索(PC+无线)用户量(万)")), BusinessUnit.SEARCH));
    PROJECTS.add(APP_SEARCH = new Project(27, "iepyipalep95q36u", "应用搜索",
        Lists.newArrayList(new Kpi(51, "应用搜索日分发量(万)"), new Kpi(52, "软件搜索日分发量(万)")), BusinessUnit.SEARCH));
    PROJECTS.add(SHOPPING_SEARCH = new Project(142, "hxuuaa7ylg2tizpp", "购物搜索",
        Lists.newArrayList(new Kpi(53, "PC+无线购物搜索用户量(万)")), BusinessUnit.SEARCH));
    ...
    PROJECTS
        .add(PEDIA = new Project(
            ...
            BusinessUnit.SEARCH));
    PROJECTS.add(CHINESE_MEDICINE = new Project(306, "zvn6s7zwq56ri18y",
    ...
    PROJECTS.add(new Project(42, "qfysv8ha64crrdsc", "糖猫",
        Lists.newArrayList(new Kpi(77, "糖猫日新激活(个)"), new Kpi(88, "糖猫T1日新激活(个)"), new Kpi(89, "糖猫T2日新激活(个)"),
            new Kpi(90, "糖猫E1日新激活(个)"), new Kpi(91, "糖猫M1日新激活(个)"), new Kpi(92, "糖猫BASIC日新激活(个)"),
            new Kpi(78, "糖猫日活跃用户(个)"), new Kpi(83, "糖猫T1日活跃用户(个)"), new Kpi(84, "糖猫T2日活跃用户(个)"),
