...
public class Project {
  ...
  static {
    ...
    PROJECTS.add(new Project(76, "423ftqdz3cyjpa14", "浏览器-手机浏览器",
        ...
        BusinessUnit.DESKTOP));
    PROJECTS.add(new Project(260, "zmit8fzhdlyqj5hd",
        ...
        BusinessUnit.DESKTOP));
    PROJECTS.add(
        new Project(82, "95lykq31ci0fw5p7", "语音", Lists.newArrayList(new Kpi(26, "语音日请求量(万)")), BusinessUnit.DESKTOP));
    PROJECTS
    ...
    PROJECTS.add(new Project(142, "hxuuaa7ylg2tizpp", "购物搜索", Lists.newArrayList(new Kpi(53, "PC+无线购物搜索用户量(万)")),
        BusinessUnit.SEARCH));
