...
public class Project {
  ...
  static {
    ...
    PROJECTS.add(new Project(70, "j0a37izra1v4n4k0", "输入法-PC输入法",
        Sets.newHashSet(new Kpi(1, "PC输入法日活跃用户数(万)", 1), new Kpi(2, "PC输入法灵犀日搜索量(万)", 1)), BusinessUnit.DESKTOP));
    PROJECTS.add(new Project(78, "mxvqf109b7kbyfad", "输入法-手机输入法",
        Sets.newHashSet(new Kpi(3, "手机输入法日活跃用户数(万)", 1), new Kpi(4, "手机输入法iOS版日活跃用户数(万)", 1),
    ...
    PROJECTS.add(new Project(157, "u9h63f6k3kxy1qfc", "输入法-QQ输入法",
        Sets.newHashSet(new Kpi(11, "QQ输入法Windows版日活跃用户数(万)", 1), new Kpi(12, "QQ输入法Android版日活跃用户数(万)", 1)),
        BusinessUnit.DESKTOP));
    PROJECTS.add(new Project(68, "2ej50d9vfy9aa486", "浏览器-PC浏览器",
        Sets.newHashSet(new Kpi(13, "PC浏览器日主动活跃用户数(万)", 1), new Kpi(14, "PC浏览器给搜索带来的自有网页PC搜索日搜索量(万)", 1)),
        BusinessUnit.DESKTOP));
    PROJECTS.add(new Project(76, "423ftqdz3cyjpa14", "浏览器-手机浏览器",
        Sets.newHashSet(new Kpi(15, "手机浏览器日活跃用户数(万)", 1), new Kpi(16, "手机浏览器给搜索带去的日搜索量(万)", 1),
    ...
    PROJECTS.add(new Project(260, "zmit8fzhdlyqj5hd", "导航",
        Sets.newHashSet(new Kpi(21, "导航合计用户数(万)", 1), new Kpi(22, "搜狗导航自有活跃用户数(万)", 1),
            new Kpi(23, "搜狗导航外购活跃用户数(万)", 1), new Kpi(24, "QQ独立导航活跃用户数(万)", 1), new Kpi(25, "QQ浏览器中QQ导航活跃用户数(万)", 1)),
        BusinessUnit.DESKTOP));
    PROJECTS.add(
        new Project(82, "95lykq31ci0fw5p7", "语音", Sets.newHashSet(new Kpi(26, "语音日请求量(万)", 1)), BusinessUnit.DESKTOP));
    PROJECTS.add(new Project(322, "hw9cfh7zaor7kuwd",
        "个性化", Sets.newHashSet(new Kpi(27, "个性化阅读日活跃用户数(万)", 1), new Kpi(28, "个性化阅读日激活量(万)", 1),
    ...
    PROJECTS.add(new Project(148, "h0wb4btxx2xm56xp", "手机地图",
        Sets.newHashSet(new Kpi(32, "手机地图日活跃用户数(万)", 1), new Kpi(33, "手机地图日激活量(万)", 1),
        ...
        BusinessUnit.DESKTOP));
    PROJECTS.add(new Project(137, "sp6jmm92s2p1u8qn", "PC网页搜索", Sets.newHashSet(new Kpi(37, "PC搜狗自有渠道日搜索量(万)", 1),
        new Kpi(38, "PC腾讯渠道日搜索量(万)", 1), new Kpi(39, "PC外购网页日搜索量(万)", 1)), BusinessUnit.SEARCH));
    PROJECTS.add(new Project(20, "z1fv4fciko2gwurq", "无线网页搜索", Sets.newHashSet(new Kpi(40, "无线搜狗自有渠道日搜索量(万)", 1),
    ...
    PROJECTS.add(new Project(232, "sohampb0dogwgxuz", "搜索APP",
        Sets.newHashSet(new Kpi(43, "搜索APP日活跃用户数(万)", 1), new Kpi(44, "搜索APP日搜索量(万)", 1),
            new Kpi(45, "搜索APP日激活量(万)", 1), new Kpi(46, "搜索APP次日留存率", 2), new Kpi(47, "搜索APP7日留存率", 8),
            new Kpi(48, "搜索APP30日留存率", 31)),
        BusinessUnit.SEARCH));
    PROJECTS.add(new Project(141, "t4nnt1t5a055mjch", "视频搜索", Sets.newHashSet(new Kpi(49, "视频搜索(PC+无线)用户量(万)", 1)),
        BusinessUnit.SEARCH));
    PROJECTS.add(new Project(138, "wzze931ap6087cf7", "图片搜索", Sets.newHashSet(new Kpi(50, "图片搜索(PC+无线)用户量(万)", 1)),
        BusinessUnit.SEARCH));
    PROJECTS.add(new Project(27, "iepyipalep95q36u", "应用搜索",
        Sets.newHashSet(new Kpi(51, "应用搜索日分发量(万)", 1), new Kpi(52, "软件搜索日分发量(万)", 1)), BusinessUnit.SEARCH));
    PROJECTS.add(new Project(142, "hxuuaa7ylg2tizpp", "购物搜索", Sets.newHashSet(new Kpi(53, "PC+无线购物搜索用户量(万)", 1)),
        BusinessUnit.SEARCH));
    PROJECTS.add(new Project(31, "1k5rg0vny4y1htl2", "小说搜索",
        Sets.newHashSet(new Kpi(54, "小说搜索搜索量(万)", 1), new Kpi(207, "阅读APPAndroid版日活跃用户数(万)", 1),
    ...
    PROJECTS
        .add(new Project(
            116, "4t8hnsfb3igf9p91", "百科、问问", Sets.newHashSet(new Kpi(59, "百科:百科UV(PC+无线)", 1),
                new Kpi(60, "百科:月编辑版本数", 1), new Kpi(61, "问问:有效写入量(日均)", 1), new Kpi(62, "问问:用户规模(PV)", 1)),
        BusinessUnit.SEARCH));
    PROJECTS.add(new Project(306, "zvn6s7zwq56ri18y",
        "中医项目", Sets.newHashSet(new Kpi(63, "中医项目App日活", 1), new Kpi(64, "中医项目App次日留存率", 2),
    ...
    PROJECTS.add(new Project(36, "1ou8k1pdoe4ac3lz", "消耗、RPM",
        Sets.newHashSet(new Kpi(68, "全部竞价日消耗(万元)", 1), new Kpi(69, "PC搜索日消耗(万元)", 1), new Kpi(70, "无线搜索日消耗(万元)", 1),
    ...
    PROJECTS.add(new Project(42, "qfysv8ha64crrdsc", "糖猫",
        Sets.newHashSet(new Kpi(77, "糖猫日新激活(个)", 1), new Kpi(78, "糖猫日活跃用户(个)", 1), new Kpi(79, "糖猫日活跃APP用户(个)", 1),
