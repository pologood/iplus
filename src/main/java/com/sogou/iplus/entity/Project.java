...
public class Project {
  ...
  static {
    PROJECTS.add(new Project(0, 0, "i4zqbwchh23igzwe", "test", new ArrayList<>(), null));
    PROJECTS.add(PC_INPUT = new Project(70, 10048, "j0a37izra1v4n4k0",
    ...
    PROJECTS
        .add(NEWS = new Project(322, 10051, "hw9cfh7zaor7kuwd", "个性化阅读",
            ...
            BusinessUnit.DESKTOP));
    PROJECTS.add(MAP = new Project(148, 10052, "h0wb4btxx2xm56xp", "手机地图",
    ...
    PROJECTS.add(SEARCH_APP = new Project(232, 10059, "sohampb0dogwgxuz", "搜索APP",
        ...
        BusinessUnit.SEARCH));
    PROJECTS.add(VEDIO_SEARCH = new Project(141, 10060, "t4nnt1t5a055mjch", "视频搜索",
        Lists.newArrayList(new Kpi(49, "视频搜索(PC+无线)用户量(万)", "活跃用户", 1)), BusinessUnit.SEARCH));
    PROJECTS.add(PICTURE_SEARCH = new Project(138, 10061, "wzze931ap6087cf7", "图片搜索",
        Lists.newArrayList(new Kpi(50, "图片搜索(PC+无线)用户量(万)", "活跃用户", 1)), BusinessUnit.SEARCH));
    PROJECTS.add(APP_SEARCH = new Project(27, 10062, "iepyipalep95q36u", "应用搜索",
    ...
    PROJECTS.add(NOVEL_SEARCH = new Project(31, 10064, "1k5rg0vny4y1htl2", "小说搜索",
        ...
        BusinessUnit.SEARCH));
    PROJECTS.add(PEDIA = new Project(116, 10065,
        ...
        BusinessUnit.SEARCH));
    PROJECTS.add(CHINESE_MEDICINE = new Project(306, 10066, "zvn6s7zwq56ri18y", "中医项目",
        ...
        BusinessUnit.SEARCH));
    PROJECTS.add(MARKETING = new Project(36, 10067, "1ou8k1pdoe4ac3lz", "消耗、RPM",
    ...
    PROJECTS.add(SUGAR_CAT = new Project(42, 10069, "qfysv8ha64crrdsc", "糖猫",
  ...
  public Project(Integer xmId, Integer appId, String xmKey, String projectName, List<Kpi> kpis,
  ...
  public Project(Project project) {
    this(project.getXmId(), project.getAppId(), project.getXmKey(), project.getProjectName(),
